...
import SteeringAngleUtils as st_util
...
#Compute Angle
land_follower = st_util.HandCodedLaneFollower()
combo_image = land_follower.follow_lane(segmented_image)

# visualize result
cv2.imshow('Overlayed Image', result)
#cv2.imshow('Segmented Image', segmented_image)

st_util.show_image('final', combo_image, True)
cv2.waitKey(0)
